...
public final class ActivityResultsBinding implements ViewBinding {
  ...
  private ActivityResultsBinding(@NonNull CoordinatorLayout rootView,
      @NonNull FloatingActionButton fabClear, @NonNull RecyclerView recyclerResults,
  ...
  public static ActivityResultsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityResultsBinding((CoordinatorLayout) rootView, fabClear, recyclerResults,
          toolbar, tvEmpty);
    }
